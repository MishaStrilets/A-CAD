		...
		<div class="col-sm-3">
			<form id="form">
				<br> <label for="left">Left</label> <br> <input
					type="text" name="left" id="left"> <br> <label
					for="top">Top</label> <br> <input type="text" name="top"
					id="top"> <br> <label for="width">Width of
					shape</label> <br> <input type="text" name="width" id="width">
				<br> <label for="height">Height of shape</label> <br> <input
					type="text" name="height" id="height"> <br> <label
					for="color">Color of shape</label> <br> <input type="text"
					name="color" id="color"><br>
				<button type="button" class="btn btn-info" onclick="showShape()">Show
					shape</button>
				<br>
